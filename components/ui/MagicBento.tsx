...
const cardData: BentoCardProps[] = [
  {
    color: "#060010",
    title: "UI & UX Design",
    description: "End-to-end product interaction design  from first sketch to developer-ready spec",
    label: "Design",
  },
  {
    color: "#060010",
    title: "Frontend Development",
    description: "Fast, responsive and SEO-ready web applications",
    label: "Development",
  },
  {
    color: "#060010",
    title: "Cloud Infrastructure",
    description: "Multi-cloud architectures that scale with demand and budget",
    label: "DevOps",
  },
  {
    color: "#060010",
    title: "User Research",
    description: "Deep qualitative and quantitative insights into user behavior",
    label: "Research",
  },
  {
    color: "#060010",
    title: "Product Management",
    description: "Strategy to backlog  turning vision into shippable stories",
    label: "Management",
  },
  {
    color: "#060010",
    title: "Brand Identity",
    description: "Foundational assets that define who you are",
    label: "Branding",
  },
];
