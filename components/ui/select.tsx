...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      `flex h-9 items-center justify-between whitespace-nowrap ${glassInputClass} py-2 data-[placeholder]:text-white/35 [&>span]:line-clamp-1`,
      className
    )}
    {...props}
  >
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(`px-2 py-1.5 text-sm font-semibold ${glassMenuLabelClass}`, className)}
    {...props}
  />
))
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      `relative flex w-full cursor-default select-none items-center py-1.5 pl-2 pr-8 text-sm outline-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 ${glassMenuItemClass}`,
      className
    )}
    {...props}
  >
